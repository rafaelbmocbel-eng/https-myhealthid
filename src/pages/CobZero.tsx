        ...
        <div className="container py-6 max-w-4xl">
          ...
          <Card>
            <CardContent className="py-10 text-center">
              <Users className="h-10 w-10 mx-auto mb-3 text-blue-600 opacity-70" />
              <h3 className="font-bold text-base text-foreground mb-1">Acesse seus clientes</h3>
              <p className="text-sm text-muted-foreground mb-4 max-w-sm mx-auto">
                A gestão e seleção de pacientes está centralizada no serviço <strong>Clientes</strong>. Abra o perfil do cliente e inicie a avaliação COB° ZERO por lá.
              </p>
              <Button
