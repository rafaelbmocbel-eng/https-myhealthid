    ...
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center space-y-4">
        ...
        <p className="text-muted-foreground text-sm">
          O <strong>Método Identidade</strong> foi substituído pela avaliação <strong>MyID v2.0</strong>.
          Os dados históricos continuam disponíveis dentro do perfil de cada paciente.
        </p>
