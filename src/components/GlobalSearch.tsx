...
const ITEMS: NavItem[] = [
  ...
  { label: 'Zap · Conversas', href: '/crm?tab=inbox', icon: MessageCircle, keywords: 'whatsapp conversa mensagem chat', group: 'CRM' },
  { label: 'Zap · Pipeline', href: '/crm?tab=pipeline', icon: Kanban, keywords: 'funil vendas lead oportunidade kanban', group: 'CRM' },
  { label: 'Zap · Cadências', href: '/crm?tab=cadencias', icon: Workflow, keywords: 'automacao sequencia followup', group: 'CRM' },
  { label: 'Zap · Métricas', href: '/crm?tab=metricas', icon: TrendingUp, keywords: 'kpi conversao analise', group: 'CRM' },
