...
export const STRUCTURES: Record<string, RegionStructures> = {
  ...
  ombro_d: {
    ...
    articulacoes: ['Glenoumeral', 'Acromioclavicular', 'Esternoclavicular', 'Escápulo-torácica'],
    musculos: ['Deltoide', 'Supraespinhal', 'Infraespinhal', 'Subescapular', 'Redondo menor', 'Redondo maior', 'Trapézio (inserção)', 'Peitoral menor', 'Serrátil anterior', 'Coracobraquial (origem)', 'Bíceps braquial (cabeças, origem)', 'Levantador da escápula'],
  ...
  cotovelo_d: {
    ...
    musculos: ['Bíceps braquial (inserção)', 'Braquial (inserção)', 'Braquiorradial (origem)', 'Pronador redondo (origem)', 'Origem comum dos flexores (epicôndilo medial)', 'Origem comum dos extensores (epicôndilo lateral)', 'Supinador'],
  ...
  cotovelo_p_d: {
    ossos: ['Úmero distal', 'Rádio (cabeça)', 'Ulna (olécrano)'],
    articulacoes: ['Úmero-ulnar', 'Úmero-radial', 'Rádio-ulnar prox.'],
    musculos: ['Tríceps braquial (inserção no olécrano)', 'Ancôneo', 'Origem comum dos extensores (epicôndilo lateral)', 'Origem comum dos flexores (epicôndilo medial)'],
  ...
  antebraco_d: {
    ...
    musculos: ['Flexor radial do carpo', 'Flexor ulnar do carpo', 'Palmar longo', 'Flexor superficial dos dedos', 'Flexor profundo dos dedos', 'Flexor longo do polegar', 'Pronador redondo', 'Pronador quadrado', 'Braquiorradial', 'Extensor radial longo do carpo', 'Extensor radial curto do carpo', 'Extensor dos dedos', 'Extensor ulnar do carpo', 'Supinador', 'Abdutor longo do polegar'],
  ...
  lombar: {
    ...
    musculos: ['Multífidos', 'Quadrado lombar', 'Eretores da espinha (iliocostal, longuíssimo, espinhal)', 'Psoas maior', 'Latíssimo do dorso (origem)', 'Serrátil posterior inferior'],
    nervos: ['Raízes L1-L5'],
  ...
  pelve: {
    ...
    musculos: ['Iliopsoas', 'Piriforme', 'Assoalho pélvico (levantador do ânus)', 'Coccígeo', 'Obturador interno', 'Obturador externo', 'Gêmeo superior', 'Gêmeo inferior', 'Quadrado femoral'],
    ligamentos: ['Sacrotuberoso', 'Sacroespinhoso', 'Inguinal', 'Iliolombar'],
  ...
  gluteos: {
    ...
    musculos: ['Glúteo máximo', 'Glúteo médio', 'Glúteo mínimo', 'Piriforme', 'Tensor da fáscia lata', 'Quadrado femoral', 'Gêmeo superior', 'Gêmeo inferior', 'Obturador interno', 'Obturador externo'],
    ligamentos: ['Sacrotuberoso', 'Sacroespinhoso', 'Trato iliotibial'],
    nervos: ['Ciático', 'Glúteo superior', 'Glúteo inferior', 'Cutâneo femoral posterior', 'Pudendo'],
    vasos: ['Artéria glútea superior', 'Artéria glútea inferior', 'Artérias circunflexas femorais'],
  },
  // ── COXA ──
  coxa_d: {
    ossos: ['Fêmur (diáfise)'],
    musculos: ['Reto femoral', 'Vasto lateral', 'Vasto medial', 'Vasto intermédio', 'Sartório', 'Pectíneo', 'Adutor longo', 'Adutor curto', 'Adutor magno', 'Grácil', 'Tensor da fáscia lata', 'Iliopsoas (inserção)'],
    nervos: ['Femoral', 'Obturador', 'Cutâneo femoral lateral'],
  ...
  // ── JOELHO ──
  joelho_d: {
    ossos: ['Fêmur distal', 'Patela', 'Tíbia proximal', 'Fíbula (cabeça)'],
    articulacoes: ['Femorotibial', 'Femoropatelar', 'Tibiofibular proximal'],
    musculos: ['Quadríceps femoral (tendão)', 'Poplíteo', 'Gastrocnêmio (cabeças)', 'Bíceps femoral (inserção)', 'Semitendíneo', 'Semimembranoso', 'Sartório', 'Grácil', 'Tensor da fáscia lata (trato iliotibial)'],
    ligamentos: ['LCA', 'LCP', 'LCM', 'LCL', 'Menisco medial', 'Menisco lateral', 'Ligamento patelar', 'Pata de ganso', 'Retináculos patelares', 'Bolsas (pré-patelar, infrapatelar)'],
    nervos: ['Fibular comum', 'Tibial', 'Safeno (ramo infrapatelar)'],
  ...
  canela_d: {
    ...
    musculos: ['Tibial anterior', 'Fibular longo', 'Fibular curto', 'Extensor longo dos dedos', 'Extensor longo do hálux', 'Terceiro fibular'],
    ligamentos: ['Retináculo dos extensores'],
  ...
  panturr_d: {
    ...
    musculos: ['Gastrocnêmio', 'Sóleo', 'Plantar', 'Poplíteo', 'Tibial posterior', 'Flexor longo dos dedos', 'Flexor longo do hálux'],
