...
export const REGIONS: Region[] = [
  ...
  { id: 'cotovelo_d',   label: 'Cotovelo D',   view: 'front', cx: 56,  cy: 199,
    d: 'M45 199 A11 22 0 1 0 67 199 A11 22 0 1 0 45 199 Z' },
  ...
  { id: 'cotovelo_e',   label: 'Cotovelo E',   view: 'front', cx: 184, cy: 199,
    d: 'M173 199 A11 22 0 1 0 195 199 A11 22 0 1 0 173 199 Z' },
  ...
  { id: 'coxa_d',       label: 'Coxa D',       view: 'front', cx: 96,  cy: 311,
    d: 'M84 270 L116 270 L114 353 L78 353 Z' },
  { id: 'joelho_d',     label: 'Joelho D',     view: 'front', cx: 96,  cy: 368,
    d: 'M79 368 A17 14 0 1 0 113 368 A17 14 0 1 0 79 368 Z' },
  { id: 'canela_d',     label: 'Canela D',     view: 'front', cx: 96,  cy: 436,
    d: 'M80 383 L110 383 L106 490 L82 490 Z' },
  ...
  { id: 'coxa_e',       label: 'Coxa E',       view: 'front', cx: 144, cy: 311,
    d: 'M124 270 L156 270 L162 353 L126 353 Z' },
  { id: 'joelho_e',     label: 'Joelho E',     view: 'front', cx: 144, cy: 368,
    d: 'M127 368 A17 14 0 1 0 161 368 A17 14 0 1 0 127 368 Z' },
  { id: 'canela_e',     label: 'Canela E',     view: 'front', cx: 144, cy: 436,
    d: 'M130 383 L160 383 L158 490 L134 490 Z' },
  ...
  { id: 'dorsal',       label: 'Dorsal',       view: 'back', cx: 120, cy: 160,
    d: 'M88 130 L152 130 C 162 133 168 138 168 144 Q 165 165 160 184 Q 120 191 80 184 Q 75 165 72 144 C 72 138 78 133 88 130 Z' },
  { id: 'lombar',       label: 'Lombar',       view: 'back', cx: 120, cy: 205,
    d: 'M80 184 Q 120 191 160 184 C 163 198 163 210 162 226 Q 120 220 78 226 C 77 210 77 198 80 184 Z' },
  { id: 'gluteos',      label: 'Glúteos',      view: 'back', cx: 120, cy: 248,
    d: 'M78 226 Q 120 220 162 226 C 165 240 162 254 156 270 Q 120 278 84 270 C 78 254 75 240 78 226 Z' },
  { id: 'braco_p_d',    label: 'Tríceps D',    view: 'back', cx: 178, cy: 168,
    d: 'M184 132 L192 168 L176 184 L168 144 Z' },
  { id: 'cotovelo_p_d', label: 'Cotovelo D',   view: 'back', cx: 184, cy: 200,
    d: 'M173 200 A11 22 0 1 0 195 200 A11 22 0 1 0 173 200 Z' },
  ...
  { id: 'cotovelo_p_e', label: 'Cotovelo E',   view: 'back', cx: 56,  cy: 200,
    d: 'M45 200 A11 22 0 1 0 67 200 A11 22 0 1 0 45 200 Z' },
  { id: 'antebr_p_e',   label: 'Antebraço E',  view: 'back', cx: 48,  cy: 250,
    d: 'M40 230 L36 280 L52 280 L58 224 Z' },
  { id: 'mao_p_e',      label: 'Mão E',        view: 'back', cx: 48,  cy: 296,
    d: 'M36 280 L44 308 L56 308 L52 280 Z' },
  { id: 'isquio_d',     label: 'Isquiotibial D', view: 'back', cx: 144, cy: 311,
    d: 'M124 270 L156 270 L162 353 L126 353 Z' },
  { id: 'cavo_d',       label: 'Poplíteo D',   view: 'back', cx: 144, cy: 368,
    d: 'M127 368 A17 14 0 1 0 161 368 A17 14 0 1 0 127 368 Z' },
  { id: 'panturr_d',    label: 'Panturrilha D', view: 'back', cx: 144, cy: 436,
    d: 'M130 383 L160 383 L158 490 L134 490 Z' },
  { id: 'calc_d',       label: 'Calcanhar D',  view: 'back', cx: 144, cy: 502,
    d: 'M134 490 L158 490 L152 510 L138 510 Z' },
  { id: 'isquio_e',     label: 'Isquiotibial E', view: 'back', cx: 96, cy: 311,
    d: 'M84 270 L116 270 L114 353 L78 353 Z' },
  { id: 'cavo_e',       label: 'Poplíteo E',   view: 'back', cx: 96,  cy: 368,
    d: 'M79 368 A17 14 0 1 0 113 368 A17 14 0 1 0 79 368 Z' },
  { id: 'panturr_e',    label: 'Panturrilha E', view: 'back', cx: 96, cy: 436,
    d: 'M80 383 L110 383 L106 490 L82 490 Z' },
