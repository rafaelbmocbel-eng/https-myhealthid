...
export const REGIONS: Region[] = [
  ...
  { id: 'mao_p_e',      label: 'Mão E',        view: 'back', cx: 48,  cy: 296,
    d: 'M36 280 L44 308 L56 308 L52 280 Z' },
  { id: 'isquio_d',     label: 'Isquiotibial D', view: 'back', cx: 144, cy: 318,
    d: 'M124 270 L156 270 L162 368 L126 368 Z' },
  { id: 'cavo_d',       label: 'Poplíteo D',   view: 'back', cx: 144, cy: 383,
    d: 'M127 383 A17 14 0 1 0 161 383 A17 14 0 1 0 127 383 Z' },
  { id: 'panturr_d',    label: 'Panturrilha D', view: 'back', cx: 144, cy: 446,
    d: 'M130 398 L160 398 L158 490 L134 490 Z' },
  { id: 'calc_d',       label: 'Calcanhar D',  view: 'back', cx: 144, cy: 502,
    d: 'M134 490 L158 490 L152 510 L138 510 Z' },
  { id: 'isquio_e',     label: 'Isquiotibial E', view: 'back', cx: 96, cy: 318,
    d: 'M84 270 L116 270 L114 368 L78 368 Z' },
  { id: 'cavo_e',       label: 'Poplíteo E',   view: 'back', cx: 96,  cy: 383,
    d: 'M79 383 A17 14 0 1 0 113 383 A17 14 0 1 0 79 383 Z' },
  { id: 'panturr_e',    label: 'Panturrilha E', view: 'back', cx: 96, cy: 446,
    d: 'M80 398 L110 398 L106 490 L82 490 Z' },
