...
import { format, parseISO, parse } from '@/lib/dateSafe';
                  ...
                  {isProfessional && rings.length > 0 && (() => {
                    ...
                    return (
                      <div className="mt-4 grid gap-3 sm:grid-cols-2">
                        <p className="text-[10.5px] text-muted-foreground">Internos (sustento): nota, maior = melhor · Externos (pressão): intensidade, maior = pior.</p>
                                ...
                                return (
                                  <li key={ring.scoreKey} className="flex gap-2 text-[12.5px] leading-snug">
                                    ...
                                    <span className="flex-1">
                                      ...
                                      <span className="text-muted-foreground"> · {ring.type === 'inner' ? 'nota' : 'intensidade'} </span>
