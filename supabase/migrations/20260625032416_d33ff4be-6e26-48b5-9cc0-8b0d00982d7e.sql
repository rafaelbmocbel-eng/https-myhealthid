...
DROP POLICY IF EXISTS "Terapeuta gerencia cache de insights" ON public.myid_dimension_insights_cache;
...
CREATE OR REPLACE TRIGGER trg_myid_dim_cache_updated_at
